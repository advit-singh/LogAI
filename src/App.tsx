  ...
  return (
    <GlobalStateProvider>
      <ThemeProvider defaultTheme="system" storageKey="journal-theme">
        <BrowserRouter>
          <div className={cn("min-h-screen bg-background flex flex-col", isAuthenticated ? "" : "items-center justify-center")}>
            {isAuthenticated ? (
              <>
                <Header />
              ...
              <div className="w-full max-w-md space-y-8">
                <div className="text-center">
                  ...
                  <p className="mt-2 text-lg text-muted-foreground">Your personal AI-powered journaling companion</p>
                </div>
                <AuthForm />
              </div>
            )}
